...
const (
	...
	Track_GetPlayURL_FullMethodName = "/track.Track/GetPlayURL"
)
...
func (c *trackClient) GetPlayURL(ctx context.Context, in *GetPlayURLRequest, opts ...grpc.CallOption) (*GetPlayURLResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPlayURLResponse)
	err := c.cc.Invoke(ctx, Track_GetPlayURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTrackServer) GetPlayURL(context.Context, *GetPlayURLRequest) (*GetPlayURLResponse, error) {
...
func _Track_GetPlayURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPlayURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrackServer).GetPlayURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Track_GetPlayURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrackServer).GetPlayURL(ctx, req.(*GetPlayURLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Track_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Track_GetPlayURL_Handler,
		},
	},
